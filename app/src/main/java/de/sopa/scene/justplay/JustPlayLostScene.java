 ...
 */
class JustPlayLostScene extends BaseScene {
    ...
    JustPlayLostScene(final JustPlayResult justPlayResult) {

        super();

        this.leaveScene = false;
        this.justPlayResult = justPlayResult;
        isNewHighscore = (justPlayScoreService.getHighscore() != null
                && justPlayScoreService.getHighscore().getPoints() < justPlayResult.getScore())
    ...
    private void addShareButton() {
        ...
        final ButtonSprite restartButton = new ButtonSprite((camera.getWidth() / 2 - 200), (camera.getHeight() - 400),
        ...
        final ButtonSprite shareLogo = new ButtonSprite((float) (camera.getWidth() * 0.64), (camera.getHeight() - 400),
                resourcesManager.shareScoreTexture, vbom, new ButtonSprite.OnClickListener() {
                    ...
                    public void onClick(ButtonSprite pButtonSprite, float pTouchAreaLocalX, float pTouchAreaLocalY) {
                        ...
                        shareIntent.putExtra(Intent.EXTRA_TEXT,
                            "Just gained " + justPlayResult.getScore() + " in SOPA. " + LINK_TO_STORE);
